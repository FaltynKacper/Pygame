...
BULLET_HIT_SOUND = pygame.mixer.Sound('Files/BeingHit.mp3')
BULLET_FIRE_SOUND = pygame.mixer.Sound('Files/Shot.mp3')
...
BLUE_TANK_IMAGE = pygame.image.load(
    os.path.join('Files', 'tankBlue.png'))
BLUE_TANK = pygame.transform.rotate(pygame.transform.scale(
    BLUE_TANK_IMAGE, (TANK_WIDTH, TANK_HEIGHT)), 0)

RED_TANK_IMAGE = pygame.image.load(
    os.path.join('Files', 'tankRed.png'))
RED_TANK = pygame.transform.rotate(pygame.transform.scale(
    RED_TANK_IMAGE, (TANK_WIDTH, TANK_HEIGHT)), 0)

BATTLEGROUND = pygame.transform.scale(pygame.image.load(
    os.path.join('Files', 'RockyWildernessPublic.jpg')), (WIDTH, HEIGHT))
...
def main():
    ...
    blue = pygame.Rect(100, 300, TANK_WIDTH, TANK_HEIGHT)
